...
import "./TermAndConditionsPageSecond.css";

const TermAndConditionsPageSecond = () => {
  return (
    <div className="termandconditionspagesecond">
      <ResponsiveNavbar />
        ...
        <section className="contact-us-container">
          ...
          <div className="if-you-have-container2">
            <p className="if-you-have3">
              ...
              services, please contact us at hello@Giftvoucherclouds.com.
            </p>
...
export default TermAndConditionsPageSecond;
